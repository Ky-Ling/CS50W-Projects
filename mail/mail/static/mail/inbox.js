...
function load_mail(id) {
  ...
  .then(email => {
    ...
    // Create reply button and append it to DOMContentLoaded
    ...
    // Create mark as unread and append it to DOM
...
function load_mailbox(mailbox) {
  ...
  // Show the mailbox name & clear previous child element
